...
import com.nmc.speedviewlib.components.Indicators.ImageIndicator;
import com.nmc.speedviewlib.components.Indicators.Indicator;
import com.nmc.speedviewlib.components.Indicators.NoIndicator;
import com.nmc.speedviewlib.components.note.Note;
import com.nmc.speedviewlib.util.OnPrintTickLabel;
...
public abstract class Speedometer extends Gauge {
    ...
    private int markColor = 0xFFFFFFFF
            , goodLevelColor = 0x50BA12
            , lowSpeedColor = 0xFF00FF00
            , satisfactoryLevelColor = 0x5D821F
            , moderateLevelColor = 0xE7CCE8
            , poorLevelColor = 0xF7D309
            , veryPoorLevelColor = 0xF72909
            , severeLevelColor = 0xAF2611
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        goodLevelColor = a.getColor(R.styleable.Speedometer_sv_goodLevelColor, goodLevelColor);
        satisfactoryLevelColor = a.getColor(R.styleable.Speedometer_sv_satisfactoryLevelColor, satisfactoryLevelColor);
        moderateLevelColor = a.getColor(R.styleable.Speedometer_sv_moderateLevelColor, moderateLevelColor);
        poorLevelColor = a.getColor(R.styleable.Speedometer_sv_poorLevelColor, poorLevelColor);
        veryPoorLevelColor = a.getColor(R.styleable.Speedometer_sv_veryPoorLevelColor, veryPoorLevelColor);
        severeLevelColor = a.getColor(R.styleable.Speedometer_sv_severeLevelColor, severeLevelColor);
    ...
    public int getGoodLevelColor() {
        return goodLevelColor;
    }

    /**
     * change the color of good Section.
     * @param goodLevelColor new color.
     */
    public void setGoodLevelColor(int goodLevelColor) {
        this.goodLevelColor = goodLevelColor;
        if (!isAttachedToWindow())
            return;
    ...
    public int getSatisfactoryLevelColor() {
        return satisfactoryLevelColor;
    }

    /**
     * change the color of satisfactory Section.
     * @param satisfactoryColor new color.
     */
    public void setSatisfactoryLevelColor(int satisfactoryColor) {
        this.satisfactoryLevelColor = satisfactoryColor;
        if (!isAttachedToWindow())
            return;
        updateBackgroundBitmap();
        invalidate();
    ...
    public int getModerateLevelColor() {
        return moderateLevelColor;
    }

    /**
     * change the color of moderate Section.
     * @param moderateLevelColor new color.
     */
    public void setModerateLevelColor(int moderateLevelColor) {
        this.moderateLevelColor = moderateLevelColor;
        if (!isAttachedToWindow())
            return;
        updateBackgroundBitmap();
        invalidate();
    ...
    public int getPoorLevelColor() {
        return poorLevelColor;
    }

    /**
     * change the color of poor section.
     * @param poorLevelColor new color.
     */
    public void setPoorLevelColor(int poorLevelColor) {
        this.poorLevelColor = poorLevelColor;
        if (!isAttachedToWindow())
            return;
        updateBackgroundBitmap();
        invalidate();
    ...
    public int getVeryPoorLevelColor() {
        return veryPoorLevelColor;
    }

    /**
     * change the color of veryPoor Section.
     * @param veryPoorLevelColor new color.
     */
    public void setVeryPoorLevelColor(int veryPoorLevelColor) {
        this.veryPoorLevelColor= veryPoorLevelColor;
        if (!isAttachedToWindow())
            return;
        updateBackgroundBitmap();
        invalidate();
    ...
    public int getSevereLevelColor() {
        return severeLevelColor;
    }

    /**
     * change the color of severe Section.
     * @param severeLevelColor new color.
     */
    public void setSevereLevelColor(int severeLevelColor) {
        this.severeLevelColor = severeLevelColor;
        if (!isAttachedToWindow())
            return;
        updateBackgroundBitmap();
        invalidate();
